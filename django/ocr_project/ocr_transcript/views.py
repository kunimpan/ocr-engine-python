        ...
        if errors:
            ...
            try:
                ...
                if len(output_images) >= 1:
                    ...
                    text_group_char_gpax = tn.detect_char_stud(text_group_gpax[1:])
                    ...
                    text_box_citizen_id = tn.predict_text_one_level_stud(text_group_char_citizen_id[:], 0, model_char_subject_code_tn, model_char_academic_results_tn)   
                    ...
                    text_box_gpax = tn.predict_text_multi_level_stud(text_group_char_gpax[:], model_char_level_0, model_char_level_1, model_char_level_2)
